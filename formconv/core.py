...
def create_xlsform(user_query, xlsform_filename, model, xlsform_prompt_template):
...
- If you cannot save directly to the current directory, save to /tmp and I will move it
"""
...
def generate_form_json(user_query):
    ...
    if not xlsform_result:
        raise Exception("Failed to create XLSForm")
    ...
    if json_result:
        ...
        raise Exception("Form conversion failed")